...
const Data = () => {
    return (
        ...
        <div className="home__data">
            <h1 className="home__title">Sierra Soto
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I am a determined and productive engineer with a passion for creative solutions.</p>
            <a gref="#contact" className="button button--flex">
                Say Hello !
                <svg
